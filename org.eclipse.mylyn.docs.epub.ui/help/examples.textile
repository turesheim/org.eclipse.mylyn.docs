...
p. Correctly adding a cover to a publication can be a bit awkward as different reading systems handle this differently. So there is a shortcut:

bc.. 
<cover image="cover.jpg" title="My Title"/> 

p. Simply point to the file in question and this epub tooling will take care of the rest. There is of course another, more laborious way: 
...
p. Assuming the cover image is ready we will add it using the **item** element as this:
